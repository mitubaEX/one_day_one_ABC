...
ll isP(ll a){if (a == 1) {return 0;} for(ll i = 2; i < int(sqrt(a)+1); i++) {if (a % i == 0) { return 0; }}; return 1;}
ll isPInclude1(ll a){for(ll i = 2; i < int(sqrt(a)+1); i++) {if (a % i == 0) { return 0; }}; return 1;}
